...
set CODE=C:\Users\ams56\work\pap\part2\parser\code
set BUILD=C:\Users\ams56\work\pap\part2\parser\build
...
pushd %BUILD%
"%CLANGCL%" %CommonCompilerFlags% %CODE%\parser_main.c /link %CommonLinkerFlags% /OUT:parser.exe
if %ERRORLEVEL% NEQ 0 exit /b %ERRORLEVEL%
echo parser.exe: OK
popd
