...
set CODE=C:\Users\ams56\work\pap\part2\generator\code
set BUILD=C:\Users\ams56\work\pap\part2\generator\build
set SHARED=C:\Users\ams56\work\pap\part2\shared
...
pushd %BUILD%
"%CLANGCL%" /I%SHARED% %CommonCompilerFlags% %CODE%\generator_main.c /link %CommonLinkerFlags% /OUT:generator.exe
if %ERRORLEVEL% NEQ 0 exit /b %ERRORLEVEL%
echo generator.exe: OK
popd
